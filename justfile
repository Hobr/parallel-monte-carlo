...
fortran-intel:
    sudo docker run -it --rm -v $(pwd):/workspace intel/fortran-essentials bash -c "cd /workspace && ifort -O3 -march=native -qopenmp -o dist/intel fortran/main.f90"
    ./dist/intel

fortran: fortran-g fortran-intel
